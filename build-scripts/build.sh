...
POSTGRESS_POD_IP=$(cat /etc/hosts | grep postgresql | awk '{print $1}')
podman pod create --name postgresql -p 5432 -p 5432 --network rhel-edge --ip ${POSTGRESS_POD_IP}
...
--name=postgresql-12 registry.redhat.io/rhel8/postgresql-12 
